...
# # vector = uriel.vector("syntactic", iso_code_langs) #Replace "syntactic" with "geographic" for geo.pt. 
...
vector = uriel.vector("syntactic", glottocode_langs) #Replace "syntactic" with "geographic" for geo.pt, vice-versa for syntax_knn.pt or syntax_average.pt.
